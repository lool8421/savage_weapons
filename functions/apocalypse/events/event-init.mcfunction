...
execute if score apoc_time sw_var matches 0..400 run function savage_weapons:apocalypse/events/super-earthquake
execute if score apoc_time sw_var matches 0..200 run function savage_weapons:apocalypse/events/super-earthquake
...
execute if score apoc_time sw_var matches 0..800 as @a at @s summon marker run function savage_weapons:apocalypse/events/lava-rain
execute if score apoc_time sw_var matches 0..600 as @a at @s summon marker run function savage_weapons:apocalypse/events/lava-rain
execute if score apoc_time sw_var matches 0..400 as @a at @s summon marker run function savage_weapons:apocalypse/events/lava-rain

execute if score apoc_time sw_var matches 0..400 if predicate savage_weapons:50percent run function savage_weapons:apocalypse/events/blind
