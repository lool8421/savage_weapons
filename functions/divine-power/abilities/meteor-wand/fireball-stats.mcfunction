...
execute store result entity @s Motion[0] double 0.015 run scoreboard players get fireballX sw_var
execute store result entity @s Motion[1] double 0.015 run scoreboard players get fireballY sw_var
execute store result entity @s Motion[2] double 0.015 run scoreboard players get fireballZ sw_var
