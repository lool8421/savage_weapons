...
execute if score out rng matches 91..120 run tellraw @a[distance=..150] [{"text":"<"},{"text":"OmegaDragon","bold":"true","color":"dark_purple"},{"text":">"},{"color":"dark_red","bold":"true","text":" YOUR EXISTENCE WILL BE ERASED FROM THE PHYSICAL PLANE!"}]
