...
#2nd
summon marker ^1 ^ ^10 {Tags:['sw_direction2']}
...
#3rd
summon marker ^-1 ^ ^10 {Tags:['sw_direction3']}
...
summon fireball ^ ^ ^15 {Tags:['sw_dragon_fireball_1'],Passengers:[{id:"minecraft:marker",Tags:['sw_dragon_damage','sw_temporary']}]}
summon fireball ^2 ^ ^15 {Tags:['sw_dragon_fireball_2'],Passengers:[{id:"minecraft:marker",Tags:['sw_dragon_damage','sw_temporary']}]}
summon fireball ^-2 ^ ^15 {Tags:['sw_dragon_fireball_3'],Passengers:[{id:"minecraft:marker",Tags:['sw_dragon_damage','sw_temporary']}]}
