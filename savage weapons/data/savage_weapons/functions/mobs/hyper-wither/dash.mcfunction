...
execute store result entity @s Motion[0] double 0.04 run scoreboard players get targetX sw_var
execute store result entity @s Motion[1] double 0.04 run scoreboard players get targetY sw_var
execute store result entity @s Motion[2] double 0.04 run scoreboard players get targetZ sw_var
