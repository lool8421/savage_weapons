...
tag @s add sw_thanos
execute at @s as @e[type=!#savage_weapons:inanimates,distance=..50,tag=!sw_thanos] if predicate savage_weapons:50percent at @s run function savage_weapons:divine-power/abilities/eternity-gauntlet/snap-effects
